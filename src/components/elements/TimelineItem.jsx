const TimelineItem = ({ timeline: { company, positions, description, date } }) => {
    return (
        <div className="timeline relative flex items-start rounded-full border-white border-opacity-20 first:mt-0 md:flex">
            <span className="absolute top-2 md:top-0 left-12 mt-5 mr-12 min-w-[115px] rounded-full bg-primary bg-opacity-10 p-1 text-center text-sm leading-none md:relative md:left-0 md:w-1/5">
                {date}
            </span>
            <div className="timeline-right relative border-l-4 border-white border-opacity-20 pt-16 pl-12 md:pt-6 md:w-4/5">
